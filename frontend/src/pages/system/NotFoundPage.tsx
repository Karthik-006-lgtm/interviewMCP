  ...
  return (
    ...
    >
      <div className="glass-panel w-full max-w-2xl rounded-[2rem] p-10 text-center">
        <p className="font-display text-sm uppercase tracking-[0.35em] text-gray-700">404</p>
        <h1 className="mt-4 font-display text-4xl text-gray-900">That page doesn&apos;t exist in this workspace.</h1>
